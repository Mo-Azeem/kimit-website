        ...
        <div className="row">
          <div className="col-lg-6 pt-4">
            <div className={`${style.bodyOfContact} `}>
              <h6 className={`${style.descTitle} pt-3 `}>
              ...
              <div className="mb-3">
                <label
                  htmlFor="fullName"
                  className={`${style.label} form-label mt-3`}
                >
                  Full Name
                </label>
                <input
              ...
              <div className="mb-3">
                <label
                  ...
                  className={`${style.label} form-label mt-2`}
                >
                  Email{" "}
                </label>
                <input
              ...
              <button className="p-2 mt-3 text-white btn btn-warning w-100">
                {" "}
                Send A Message
              </button>
            </div>
          ...
          <div className="col-lg-6 ">
            <div className="image position-relative w-100  m-auto d-flex align-items-center justify-content-center ">
              <img
                src="../../contactdesc.png"
                className={`${style.mainImg}   w-100 h-100`}
                alt=""
              />
              <div
                className={`${style.contDesc} position-absolute translate-middle `}
              >
                <img
                  src="../../logo.png"
                  ...
                  alt="kimit"
                />
                <h6 className={`${style.data} ${style.firstData} pt-4`}>
                  Or contact us via :
                </h6>
